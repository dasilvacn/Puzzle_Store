...
<div class="signup-form">
    <form action="/examples/actions/confirmation.php" method="post">
        ...
        <div class="form-group">
            <label class="form-check-label"><input type="checkbox" name="uyeYonetimi" value="1" class="form-control"required="required"></label>
        </div>
        <div class="form-group">
            <label><input type="checkbox"  name="urunYonetimi" value="1" class="form-control"required="required"></label>
        </div>
        <div class="form-group">
